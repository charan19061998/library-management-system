...
SECRET_KEY = "django-insecure-gn=pt&40@1pdqzy&0$j052%cydf8c7ikhyjvrsf9z#puwm-ds7"
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Add static directory if not already added
]
...
AUTHENTICATION_BACKENDS = [
    'library.authentication.EmailBackend',  # Replace 'your_app' with your app name
